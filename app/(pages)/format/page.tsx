    ...
    return (
        <>
            ...
            <section>
                ...
                <p>
                    <T
                        sk={<>Štartovné na osobu je 50 Kč teda 100 Kč za tím.</>}
                        en={<>Entry fee per person is 50 CZK, so 100 CZK per team.</>}
                    />
                </p>
                <p>
                    <T
            ...
            <section>
                ...
                <p>
                    <T
                        sk={
                            <>
                                ...
                                <TDateTime datetime={new Date(2025, 10, 8)} type="date" />. Zápasy play-off si zahráte
                                formou BO3, teda najlepší z troch zápasov, pričom posledný sa hrá len to päť.
                                Harmonogram zápasov nájdeš
                            </>
                        }
                        en={
                            <>
                                Play-off games will be played <TDateTime datetime={new Date(2025, 10, 8)} type="date" />
                                . Play-off matches will be played BO3, i.e. best of three games, while the last game
                                only up to five points. You can find the schedule
                            </>
                        }
                    />{' '}
                    ...
                    <T
                        sk={
                            <>
                                Na každý zápas je vyhradených 20 minút. Keďže kalčeto sa nehrá na čas, harmonogram je
                                orientačný a môžu nastať mierne posuny v časoch zápasov.
                            </>
                        }
                        en={
                            <>
                                There are 20 minutes for each match. As foosball is not played on time, the schedule is
            ...
            <section>
                ...
                <p>
                    ...
                    <Link href="https://www.twitch.tv/KolejeKlacelky" className="link">
                        https://www.twitch.tv/KolejeKlacelky
                    </Link>
                </p>
                {/* <p> */}
                {/*     <T */}
